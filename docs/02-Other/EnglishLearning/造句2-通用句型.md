...
## Table of Contents
- [引出原因或解释 (Explaining Causes)](#引出原因或解释-explaining-causes)
...
- [举例说明 (Giving Examples)](#举例说明-giving-examples)
...
- [对比与让步 (Contrast and Concession)](#对比与让步-contrast-and-concession)
...
- [强调与总结 (Emphasis and Conclusion)](#强调与总结-emphasis-and-conclusion)
...
- [结果与影响 (Results and Effects)](#结果与影响-results-and-effects)
...
- [可能性与假设 (Possibility and Hypothesis)](#可能性与假设-possibility-and-hypothesis)
    - [==It is likely that ...== （很可能……）](#it-is-likely-that--很可能)
    - [==If ..., then ...== （如果……那么……）](#if--then--如果那么)
    - [==It seems that ...== （好像 / 看起来）](#it-seems-that--好像--看起来)
- [表达个人观点 (Expressing Personal Opinions)](#表达个人观点-expressing-personal-opinions)
    - [==From my perspective, ...== （从我的角度来看，……；在我看来，……）](#from-my-perspective--从我的角度来看在我看来)
    ...
    - [==Let me just say, ...== （我得说；让我说一句……）](#let-me-just-say--我得说让我说一句)
    - [==I couldn’t agree more.== （我完全同意）](#i-couldnt-agree-more-我完全同意)
    - [==That makes sense.== （有道理 / 我明白了。）](#that-makes-sense-有道理--我明白了)
    ...
    - [==I’m on the fence about ...== （我对……还拿不定主意 / 犹豫不决）](#im-on-the-fence-about--我对还拿不定主意--犹豫不决)
- [提问与比较句型 (Questioning and Comparison Patterns)](#提问与比较句型-questioning-and-comparison-patterns)
    - [1. 通用提问句型](#1-通用提问句型)
    ...
    - [==Explain [xxx] in simple terms.==（用简单的方式解释 [xxx]。）](#explain-xxx-in-simple-terms用简单的方式解释-xxx)
    - [==Give me an example of [xxx].== （给我一个 [xxx] 的例子。）](#give-me-an-example-of-xxx-给我一个-xxx-的例子)
    - [==Give me a quick overview of [xxx].== （快速概述一下 [xxx]。）](#give-me-a-quick-overview-of-xxx-快速概述一下-xxx)
    - [==Summarize [xxx] for me.== （为我总结一下 [xxx]。）](#summarize-xxx-for-me-为我总结一下-xxx)
    - [==List the main features of [xxx].== （列出 [xxx] 的主要特征。）](#list-the-main-features-of-xxx-列出-xxx-的主要特征)
    - [==I want to know more about [xxx].== （我想了解更多关于 [xxx] 的信息。）](#i-want-to-know-more-about-xxx-我想了解更多关于-xxx-的信息)
    - [==Tell me about [xxx].== （告诉我关于[xxx]的信息。）](#tell-me-about-xxx-告诉我关于xxx的信息)
    - [==Do you have any tips for [doing something]?== （关于[做某事]，你有什么建议吗？）](#do-you-have-any-tips-for-doing-something-关于做某事你有什么建议吗)
    - [==Could you possibly ...?== （你是否能……？）](#could-you-possibly--你是否能)
    - [==I was wondering if you could ...== （我在想你是否可以……）](#i-was-wondering-if-you-could--我在想你是否可以)
    - [==Why don't you/we...?== （为什么不……呢？/不如我们……吧？）](#why-dont-youwe-为什么不呢不如我们吧)
    - [==How/What about...?==（……怎么样？）](#howwhat-about怎么样)
    - [==What time is it?== （现在几点了？）](#what-time-is-it-现在几点了)
    - [==What do/does [subject] do?== （[主语]是做什么工作的？）](#what-dodoes-subject-do-主语是做什么工作的)
    - [==What's ... like?== （……怎么样？）](#whats--like-怎么样)
    - [==What kind of ...?== （哪种……？）](#what-kind-of--哪种)
    - [==What's the matter/wrong (with)...?==（怎么了？）](#whats-the-matterwrong-with怎么了)
    ...
    - [2. 比较类句型](#2-比较类句型)
    - [==What's the difference between A and B?== （A 和 B 有什么区别？）](#whats-the-difference-between-a-and-b-a-和-b-有什么区别)
    - [==I want to know the differences between A and B.== （我想知道A和B的区别。）](#i-want-to-know-the-differences-between-a-and-b-我想知道a和b的区别)
    - [==Compare A and B.== （比较 A 和 B。）](#compare-a-and-b-比较-a-和-b)
    - [==What are the pros and cons of [xxx]?== （[xxx] 的优点和缺点是什么？）](#what-are-the-pros-and-cons-of-xxx-xxx-的优点和缺点是什么)
    - [==Which is better, A or B?== （A 和 B 哪个更好？）](#which-is-better-a-or-b-a-和-b-哪个更好)
- [常见特殊句型 (Common Special Sentence Patterns)](#常见特殊句型-common-special-sentence-patterns)
    - [1. It's... 句型](#1-its-句型)
    - [==It is/would be + adj + to do sth== （做某事是……的）](#it-iswould-be--adj--to-do-sth-做某事是的)
    - [==It takes sb some time to do sth== （做某事花费了某人多少时间）](#it-takes-sb-some-time-to-do-sth-做某事花费了某人多少时间)
    - [==It's time (for sb) to do sth== （是（某人）该做某事的时候了）](#its-time-for-sb-to-do-sth-是某人该做某事的时候了)
    - [==It is no use/good doing sth== （做某事没有用）](#it-is-no-usegood-doing-sth-做某事没有用)
    - [2. 疑问词 + to do 结构](#2-疑问词--to-do-结构)
    - [==how to do sth== （如何去做某事）](#how-to-do-sth-如何去做某事)
    - [==what to do sth== （做什么）](#what-to-do-sth-做什么)
    - [==when to do sth== （何时去做某事）](#when-to-do-sth-何时去做某事)
    - [==where to do sth== （去哪里做某事）](#where-to-do-sth-去哪里做某事)
    - [3. 使役动词和感官动词 (Causative & Sensory Verbs)](#3-使役动词和感官动词-causative--sensory-verbs)
    - [==make sb do sth== （让/迫使某人做某事）](#make-sb-do-sth-让迫使某人做某事)
    - [==let sb do sth== （允许某人做某事）](#let-sb-do-sth-允许某人做某事)
    - [==have sb do sth== （安排/叫某人做某事）](#have-sb-do-sth-安排叫某人做某事)
    - [==see/hear/watch sb do sth== （看见/听见某人做了某事，强调全过程）](#seehearwatch-sb-do-sth-看见听见某人做了某事强调全过程)
    - [==see/hear/watch sb doing sth== （看见/听见某人正在做某事，强调正在进行）](#seehearwatch-sb-doing-sth-看见听见某人正在做某事强调正在进行)
    - [4. 其他固定搭配](#4-其他固定搭配)
    - [==have to do sth== （必须做某事）](#have-to-do-sth-必须做某事)
    - [==spend time/money (in) doing sth / on sth== （花费时间/金钱在某事上）](#spend-timemoney-in-doing-sth--on-sth-花费时间金钱在某事上)
    - [==stop to do sth== （停下来去做另一件事）](#stop-to-do-sth-停下来去做另一件事)
    - [==stop doing sth== （停止正在做的事）](#stop-doing-sth-停止正在做的事)
    - [==used to do sth== （过去常常做某事，现在不了）](#used-to-do-sth-过去常常做某事现在不了)
    - [==be used to doing sth== （习惯于做某事）](#be-used-to-doing-sth-习惯于做某事)
    - [==prefer to do sth rather than do sth== （宁愿做某事而不愿做另一件事）](#prefer-to-do-sth-rather-than-do-sth-宁愿做某事而不愿做另一件事)
    - [==would rather do sth than do sth== （宁愿……也不愿……）](#would-rather-do-sth-than-do-sth-宁愿也不愿)
    - [==had better (not) do sth== （最好（不要）做某事）](#had-better-not-do-sth-最好不要做某事)
    - [==Why not do sth?== （为什么不……呢？）](#why-not-do-sth-为什么不呢)
    - [==so... that... / such... that...== （如此……以至于……）](#so-that--such-that-如此以至于)
    - [==too... to...== （太……而不能……）](#too-to-太而不能)
    - [==...enough to...== （足够……可以……）](#enough-to-足够可以)
    - [==One of the + (形容词最高级) + (复数名词)== （……中最……之一）](#one-of-the--形容词最高级--复数名词-中最之一)
    ...
    - [==find/think/make it + adj + to do sth== （发现/认为/使得做某事……）](#findthinkmake-it--adj--to-do-sth-发现认为使得做某事)
- [Develop Prompt](#develop-prompt)
    - [项目与代码库理解](#项目与代码库理解)
    - [日常开发与变更管理](#日常开发与变更管理)
    - [代码生成与修改](#代码生成与修改)
    - [调试与问题修复](#调试与问题修复)
...
- [从句 Clauses](#从句-clauses)
    - [1. 名词从句 (Noun Clauses)](#1-名词从句-noun-clauses)
    - [2. 定语从句 (Adjective Clauses)](#2-定语从句-adjective-clauses)
    - [3. 状语从句 (Adverbial Clauses)](#3-状语从句-adverbial-clauses)
- [Introduction](#introduction)

## 引出原因或解释 (Explaining Causes)
...
## 可能性与假设 (Possibility and Hypothesis)
...
#### ==find/think/make it + adj + to do sth== （发现/认为/使得做某事……）
...
>
>**看功能：** 想**修饰**就用定语从句；想**充当/替代**成分就用名词性从句。
>
>**怎么使用定语从句和名词从句**？
>
>- 想用一个句子 **修饰** 先行词就用**定语从句**
