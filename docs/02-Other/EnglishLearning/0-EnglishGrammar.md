...
- Sentense Structure Analysis: https://gemini.google.com/gem/e3bc7ab76cbf
- Correction(Teacher)：https://gemini.google.com/gem/2d972bbf21a6
- Writing Assistant: https://gemini.google.com/gem/83b26c7c8a1d

---

- English Senior Teacher: https://gemini.google.com/gem/d0ecf768d7cb
...
Redundancy: 在英语中，当连词（如 and, or, but, yet）连接两个动作时，如果这两个动作的**主语是同一个**，我们通常会**省略第二个主语**。
...
**副词的位置，默认规则为：实义动词前、助动词/情态动词/be动词之后**
...
- **注意：用 a/an/s/some 都是表泛指，想表特指就用 the**
...
- 当表达 **A是B** 的**种类**、**用途**或**材料**时，无需用 of 或 's，直接将两个名词**拼接**即可。（Job opportunity）
  - 注意：当用一个名词修饰另一个名词时，前面修饰词通常用**单数**。（Job opportunitys）
- **’s 所有格：人、动物、时间**（Tom's car）
  - 地点/国家/城市/机构/团体/组织 可以可用's
...
- 想用一个句子 **修饰** 先行词就用**定语从句**
  - 想修饰前面整个句子就用 `, which`（即非限制性定语从句）
  - 注意：当先行词是不定代词（如 anything, everything, nothing）时，关系代词习惯上用 **that** 而不用 which。
...
- 如果中文句子里没有明确的谓语，那么谓语就是隐藏的“是”，并且“是”后面的内容多半是形容词。

- **转换辅助动词为介词**（中文是高频使用动词，而英文是高频使用介词，要学会运用介词来构建句子关系）

  - **工具/方式/手段：by, with, through, in**
    1. Please use English to speak -> Please speak **in** English
    2. People use the internet to learn English -> People learn Enlgish **through** the internet

  - **状态/伴随（穿着/戴着/怀着）：in, with , of**
    1. The girl who wears glasses -> The gril **with** glasses.
    2. He who is wearing a black coat -> He is **in** a black coat.
    3. She took the award **with** excitement.
...
**谓语**：不及物动词vi（和主谓宾的区别是此句型使用的动词do是==不及物动词vi，后面不能带宾语，如果非要带宾语 需要在vi后面加介词==）
...
在英语语法中，冠词是用来==修饰名词==，说明其所指是特定还是非特定的词。冠词分为定冠词 (definite article) 和不定冠词 (indefinite article) 两种。

- **不定冠词 (a/an)**：用于**==单数、可数名词==**前，表示**泛指**，即指某一类人或事物中的**任何一个**，但不具体说明是哪一个。它有“一个”或“任何一个”的含义。
- **定冠词 (the)**：用在**==单数/复数可数名词==**和**==不可数名词==**前，表示**特指**，即听者和说者都明确知道所指的是哪一个或哪些人或物。它有“那个”、“这个”或“那些”、“这些”的含义。
...
>- Giving = 动名词 = 实事
>
>- to give = 不定式 = 将来 = ==不==确==定==的形==式== = 没有发生的动作
