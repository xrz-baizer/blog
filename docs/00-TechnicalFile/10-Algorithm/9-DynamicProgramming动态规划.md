...
| values | weights | i / j     | j = 0 | j = 1 | j = 2 | j = 3 | j = 4 | j = 5 | j = 6 | j = 7 | j = 8 | j = 9 | j = 10 |
| :----: | :-----: | --------- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ------ |
...
因此不需要保存每一行的所有状态，只需要保存当前背包容量下的最大价值。

不过要从背包容量的最大值开始遍历到当前物品的重量，即倒序更新状态（`j--`）。
...
| -------------------- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ------ |
| **i = 0**（1件物品） | 0     | 0     | 3     | 3     | 3     | 3     | 3     | 3     | 3     | 3     | 3      |

| i / j                | j = 0 | j = 1 | j = 2 | j = 3 | j = 4 | j = 5 | j = 6 | j = 7 | j = 8 | j = 9 | j = 10 |
| -------------------- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ------ |
| **i = 1**（2件物品） | 0     | 0     | 3     | ==4== | ==4== | ==7== | ==7== | ==7== | ==7== | ==7== | ==7==  |

| i / j                | j = 0 | j = 1 | j = 2 | j = 3 | j = 4 | j = 5 | j = 6 | j = 7 | j = 8 | j = 9  | j = 10 |
| -------------------- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ------ | ------ |
| **i = 2**（3件物品） | 0     | 0     | 3     | 4     | ==5== | ==7== | ==8== | ==9== | ==9== | ==12== | ==12== |

| i / j                | j = 0 | j = 1 | j = 2 | j = 3 | j = 4 | j = 5 | j = 6 | j = 7  | j = 8  | j = 9  | j = 10 |
| -------------------- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ------ | ------ | ------ | ------ |
| **i = 3**（4件物品） | 0     | 0     | 3     | 4     | 5     | ==8== | ==8== | ==11== | ==12== | ==13== | ==15== |

| i / j                | j = 0 | j = 1 | j = 2 | j = 3 | j = 4 | j = 5 | j = 6 | j = 7  | j = 8  | j = 9  | j = 10 |
| -------------------- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ------ | ------ | ------ | ------ |
| **i = 4**（5件物品） | 0     | 0     | 3     | 4     | 5     | 8     | ==8== | ==11== | ==12== | ==13== | ==15== |
